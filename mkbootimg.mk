...
BUMP := $(LOCAL_PATH)/bump/open_bump.py -a
MSM8226_DTS_FILES = $(wildcard $(TOP)/$(TARGET_KERNEL_SOURCE)/arch/arm/boot/dts/msm8226-jag3gds*.dts)
...
INSTALLED_DTIMAGE_TARGET := $(LOCAL_PATH)/dtb.img
